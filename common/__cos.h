...
_MMR_MASK_i64 xMask;
  ...
  x = vreinterpret_v_i64m1_f64m1(_MM_AND_i64(vreinterpret_v_f64m1_i64m1(x), _ps_inv_sign_mask,gvl));
  ...
  emm0 = _MM_SLL_i64(emm0, vreinterpret_v_i64m1_u64m1(_MM_SET_i64(61,gvl)),gvl);
  ...
  _MMR_f64 sign_bit =  vreinterpret_v_i64m1_f64m1(emm0);
  _MMR_f64 poly_mask =  vreinterpret_v_i64m1_f64m1(emm2);
  ...
  xmm3 = poly_mask;
  y2 = vreinterpret_v_i64m1_f64m1(_MM_AND_i64(vreinterpret_v_f64m1_i64m1(xmm3), vreinterpret_v_f64m1_i64m1(y2) , gvl)); //, xmm3);
  y = vreinterpret_v_i64m1_f64m1(_MM_AND_i64(_MM_XOR_i64(vreinterpret_v_f64m1_i64m1(xmm3), _MM_SET_i64(0xffffffffffffffff,gvl),gvl),vreinterpret_v_f64m1_i64m1(y),gvl));
  y = _MM_ADD_f64(y, y2 ,gvl);
  /* update the sign */
  y = vreinterpret_v_i64m1_f64m1(_MM_XOR_i64(vreinterpret_v_f64m1_i64m1(y), vreinterpret_v_f64m1_i64m1(sign_bit) , gvl));
...
_MMR_MASK_i32 xMask;
  ...
  /* select the correct result from the two polynoms */
  xmm3 = poly_mask;
  y2 = vreinterpret_v_i32m1_f32m1(_MM_AND_i32(vreinterpret_v_f32m1_i32m1(xmm3), vreinterpret_v_f32m1_i32m1(y2) , gvl));
