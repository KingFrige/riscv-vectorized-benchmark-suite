...
_MMR_f64   _ps256_min_norm_pos      = vreinterpret_v_i64m1_f64m1(_256_min_norm_pos);
...
_MMR_MASK_i64 invalid_mask = _MM_VFLE_f64(x,_MM_SET_f64(0.0f,gvl),gvl);
  ...
  imm0 = vreinterpret_v_u64m1_i64m1(_MM_SRL_i64(vreinterpret_v_f64m1_u64m1(x), vreinterpret_v_i64m1_u64m1(_MM_SET_i64(52,gvl)), gvl));

  /* keep only the fractional part */
  _x_i = _MM_AND_i64(vreinterpret_v_f64m1_i64m1(x), _256_inv_mant_mask, gvl);
  _x_i = _MM_OR_i64(_x_i, vreinterpret_v_f64m1_i64m1(_ps256_0p5), gvl);
  x= vreinterpret_v_i64m1_f64m1(_x_i);
...
//  y = _MM_ADD_f64(y, _ps256_cephes_log_p1,gvl);
  ...
  x = _MM_ADD_f64(x, tmp,gvl);
  x = _MM_MERGE_f64(x,vreinterpret_v_i64m1_f64m1(_MM_SET_i64(0xffffffffffffffff,gvl)), invalid_mask,gvl);
...
_MMR_f32   _ps256_min_norm_pos      = vreinterpret_v_i32m1_f32m1(_256_min_norm_pos);
...
_MMR_MASK_i32 invalid_mask = _MM_VFLE_f32(x,_MM_SET_f32(0.0f,gvl),gvl);
  ...
  // can be done with AVX2
  imm0 = vreinterpret_v_u32m1_i32m1(_MM_SRL_i32(vreinterpret_v_f32m1_u32m1(x), vreinterpret_v_i32m1_u32m1(_MM_SET_i32(23,gvl)), gvl));

  /* keep only the fractional part */
  _x_i = _MM_AND_i32(vreinterpret_v_f32m1_i32m1(x), _256_inv_mant_mask, gvl);
  _x_i = _MM_OR_i32(_x_i, vreinterpret_v_f32m1_i32m1(_ps256_0p5), gvl);
  x= vreinterpret_v_i32m1_f32m1(_x_i);
...
//  y = _MM_ADD_f32(y, _ps256_cephes_log_p1,gvl);
  ...
  x = _MM_ADD_f32(x, tmp,gvl);
  x = _MM_MERGE_f32(x,vreinterpret_v_i32m1_f32m1(_MM_SET_i32(0xffffffff,gvl)), invalid_mask,gvl);
